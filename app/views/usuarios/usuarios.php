...
<table>
	...
	<section class="paginacion">
		...
		<ul>
            ...
            <a class="inicio"
                href="<?php echo ROUTE_URL.'/usuarios'?>/<?php echo $parameters['respuesta']['pagina_anterior']?>/<?php echo 0?>/<?php echo 0?><?php echo $var = ($parameters['busqueda'] != null)?'/'.str_replace(' ', '_',$parameters['busqueda']): ''?>">&laquo;</a>
            <?php endif;?> 
        ...
        <li class="Active">
            <a href="<?php echo ROUTE_URL.'/usuarios'?>/<?php echo $i?>/<?php echo 0?>/<?php echo 0?><?php echo $var = ($parameters['busqueda'] != null)?'/'.str_replace(' ', '_',$parameters['busqueda']): ''?>"><?php echo $i?></a>
        </li>
        ...
        <?php endfor;?>
          <!-- bloqueando el boton de siguiente cuando se llega a la ultima pagina -->
            ...
            <a class="fin"
                href="<?php echo ROUTE_URL.'/usuarios'?>/<?php echo $parameters['respuesta']['pagina_siguiente']?>/<?php echo 0?>/<?php echo 0?><?php echo $var = ($parameters['busqueda'] != null)?'/'.str_replace(' ', '_',$parameters['busqueda']): ''?>">&raquo;</a>
            <?php endif;?> 
		</ul>
