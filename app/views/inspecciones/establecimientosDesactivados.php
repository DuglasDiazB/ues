<?php require_once('../app/views/inc/header.php'); ?>
            ...
            <table>
	            <thead>
				    ...
				    <!-- colspan="Numero de columnas que tendra la tabla" -->
                        <th colspan="8">
                        <div class="title">
                            <p>Lista de inspecciones realizadas, se <?php echo $var = ($parameters['respuesta']['cuantos'] > 1)?'encontraron ':' encontro '?>
                            <?php echo $parameters['respuesta']['cuantos']. $var = ($parameters['respuesta']['cuantos'] > 1)?' registros':' registro'?>
                             ...
                             <p>
                                ...
                                <a href="<?php echo ROUTE_URL?>/inspecciones/establecimientosDesactivados" class="btn-editar"><i
                                    class="fas fa-redo"></i>Recargar</a>
                                <?php endif?>
                                <a href="<?php echo ROUTE_URL?>/inspecciones/index" class="btn-editar">
                                Activos</a>
		        ...
		        <tbody>
                    ...
                    <tr>
                        ...
                        <td data-label="Opciones">
                            ...
                            <a href="<?php echo ROUTE_URL?>/inspecciones/verInspeccion<?php echo $var=(isset($parameters['inspecciones']))? '/'.$parameters['inspecciones'][$i]->id_inspec.'/'.$parameters['respuesta']['pagina_actual'] . '/' . $parameters['busqueda']:''?>"
            ...
            <section class="paginacion">
		        <ul>
                    ...
                    <a class="inicio"
                    href="<?php echo ROUTE_URL.'/inspecciones/establecimientosDesactivados'?>/<?php echo $parameters['respuesta']['pagina_anterior']?><?php echo $var = ($parameters['busqueda'] != null)?'/'.str_replace(' ', '_',$parameters['busqueda']): ''?>">&laquo;</a>
                    <?php endif;?> 
                    ...
                    <li class="Active">
                    <a href="<?php echo ROUTE_URL.'/inspecciones/establecimientosDesactivados'?>/<?php echo $i?><?php echo $var = ($parameters['busqueda'] != null)?'/'.str_replace(' ', '_',$parameters['busqueda']): ''?>"><?php echo $i?></a>
                    ...
                    <a class="fin"
                        href="<?php echo ROUTE_URL.'/inspecciones/establecimientosDesactivados'?>/<?php echo $parameters['respuesta']['pagina_siguiente']?>/<?php echo $var = ($parameters['busqueda'] != null)?'/'.str_replace(' ', '_',$parameters['busqueda']): ''?>">&raquo;</a>
                    <?php endif;?>  
		        </ul> 
	        </section>
