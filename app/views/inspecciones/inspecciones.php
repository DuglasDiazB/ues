<?php require_once('../app/views/inc/header.php'); ?>
                        ...
                        <div class="title">
                            ...
                            <?php echo $parameters['respuesta']['cuantos']. $var = ($parameters['respuesta']['cuantos'] > 1)?' registros':' registro'?>
                             ...
                             <p>
                                ...
                                <a href="<?php echo ROUTE_URL?>/inspecciones" class="btn-editar"><i
		        ...
		        <tbody>
                    ...
                    <tr>
                        ...
                        <td data-label="Opciones">
                            ...
                            <a href="<?php echo ROUTE_URL?>/inspecciones/actualizarInspeccion<?php echo $var=(isset($parameters['inspecciones']))? '/'.$parameters['inspecciones'][$i]->id_inspec.'/'.$parameters['respuesta']['pagina_actual'] . '/' . $parameters['busqueda']:''?>"
            ...
            <section class="paginacion">
		        <ul>
                    ...
                    <a class="inicio"
                    href="<?php echo ROUTE_URL.'/inspecciones'?>/<?php echo $parameters['respuesta']['pagina_anterior']?><?php echo $var = ($parameters['busqueda'] != null)?'/'.str_replace(' ', '_',$parameters['busqueda']): ''?>">&laquo;</a>
                    <?php endif;?> 
                    ...
                    <a class="fin"
                        href="<?php echo ROUTE_URL.'/inspecciones'?>/<?php echo $parameters['respuesta']['pagina_siguiente']?>/<?php echo $var = ($parameters['busqueda'] != null)?'/'.str_replace(' ', '_',$parameters['busqueda']): ''?>">&raquo;</a>
                    <?php endif;?>  
		        </ul> 
	        </section>
