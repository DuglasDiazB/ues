    ...
    <th colspan="10">
        ...
        <p>
            <?php if ($parameters['busqueda'] != null):?>
                <a href="<?php echo ROUTE_URL?>/manipuladores/manipuladoresDesactivados" class="btn-editar"><i
                ...
                <?php endif?>
                        <!-- <a href="<?php echo ROUTE_URL?>/usuarios/nuevoUsuario" class="btn-ver"><i
                            ...
                            Nuevo
                        usuario</a> -->
                        <a href="<?php echo ROUTE_URL?>/manipuladores/index" class="btn-editar"><i class="fas fa-user-check"></i>Activos</a>
        ...
        <tbody>
                    ...
                    <tr>
                        ...
                        <td data-label="Opciones">
                         ...
                         <!--   <a href="<?php echo ROUTE_URL?>/manipuladores/verManipulador<?php echo $var=(isset($parameters['manipuladores']))? '/'.$parameters['manipuladores'][$i]->id_manip.'/'.$parameters['respuesta']['pagina_actual'] . '/' . $parameters['busqueda']:''?>"
                                ...
                                <a href="<?php echo ROUTE_URL?>/manipuladores/verManipulador<?php echo $var=(isset($parameters['manipuladores']))? '/'.$parameters['manipuladores'][$i]->id_manip.'/'.$parameters['respuesta']['pagina_actual'] . '/' .'Inactivo/':''?><?php echo $var = ($parameters['busqueda'] != null)?'/'.str_replace(' ', '_',$parameters['busqueda']): ''?>" 
                                    class="btn-ver"><i class="fas fa-eye"></i></a>  
                                ...
                                <a href="<?php echo ROUTE_URL.'/manipuladores/manipuladoresDesactivados'?>/<?php echo $parameters['respuesta']['pagina_actual']?><?php echo $var=(isset($parameters['manipuladores']))? '/'.$parameters['manipuladores'][$i]->id_manip:''?>/<?php echo 0?><?php echo $var = ($parameters['busqueda'] != null)?'/'.str_replace(' ', '_',$parameters['busqueda']): ''?>"
                ...
                <ul>
                    ...
                    <?php if ($parameters['respuesta']['pagina_actual'] ==  1 || $parameters['respuesta']['error'] == 1) :?>
                        ...
                        <?php elseif ($parameters['respuesta']['pagina_actual'] >  1 || $parameters['respuesta']['error'] == null):?>
                            <a class="inicio"
                            href="<?php echo ROUTE_URL.'/manipuladores'?>/manipuladoresDesactivados/<?php echo $parameters['respuesta']['pagina_anterior']?>/<?php echo 0?>/<?php echo 0?><?php echo $var = ($parameters['busqueda'] != null)?'/'.$parameters['busqueda']: ''?>">&laquo;</a>
                        <?php endif;?> 
                        ...
                        <?php for ($i=1; $i <= $parameters['respuesta']['totalPaginas']; $i++):?>
                            ...
                            <?php if ($parameters['respuesta']['pagina_actual'] == $i):?>
                                ...
                                <li class="Active">
                                    <a href="<?php echo ROUTE_URL.'/manipuladores'?>/manipuladoresDesactivados/<?php echo $i?>/<?php echo 0?>/<?php echo 0?><?php echo $var = ($parameters['busqueda'] != null)?'/'.$parameters['busqueda']: ''?>"><?php echo $i?></a>
                                </li>
                            ...
                            <?php if ($parameters['respuesta']['pagina_actual'] ==  $parameters['respuesta']['totalPaginas'] || $parameters['respuesta']['error'] == 1) :?>
                                ...
                                <?php elseif ($parameters['respuesta']['pagina_actual'] <  $parameters['respuesta']['totalPaginas'] || $parameters['respuesta']['error'] == null):?>
                                    <a class="fin"
                                    href="<?php echo ROUTE_URL.'/manipuladores'?>/manipuladoresDesactivados/<?php echo $parameters['respuesta']['pagina_siguiente']?>/<?php echo 0?>/<?php echo 0?><?php echo $var = ($parameters['busqueda'] != null)?'/'.$parameters['busqueda']: ''?>">&raquo;</a>
                                <?php endif;?> 
                            </ul>
            ...
            <?php if($parameters['manipulador']):?>
                <div class="box" id="eliminar-manipulador">
                    ...
                    <div class="cuerpo">
                        <h4>¿Desea activar el manipulador?</h4>
                        ...
                        <div class="pie">
                            ...
                            <div class="aceptar">
                                ...
                                <a href="<?php echo ROUTE_URL.'/manipuladores/manipuladoresDesactivados'?>/<?php echo $parameters['respuesta']['pagina_actual']?>/<?php echo $var=(isset($parameters['manipulador']))? $parameters['manipulador']->id_manip:''?>/<?php echo 1?><?php echo $var = ($parameters['busqueda'] != null)?'/'.str_replace(' ', '_',$parameters['busqueda']): ''?>"
