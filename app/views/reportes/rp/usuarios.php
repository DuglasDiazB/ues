...
// Cabecera de página
    ...
    // Título
     $this->Cell(70,10,'Unidad Comunitaria de Salud Familiar',0,0,'C');
      $this->Ln(8);
      $this->Cell(60);
     $this->Cell(70,10,'Reporte General de Usuarios',0,0,'C');
    ...
    // Salto de línea
     ...
     $this->Cell(20, 8, 'DIRECCION', 0, 0, 'C', 1);
     $this->Cell(20, 8, 'TELEFONO', 0, 0, 'C', 1);
     $this->Cell(20, 8, 'DUI', 0, 0, 'C', 1);
     $this->Cell(50, 8, 'SEXO', 0, 0, 'C', 1);
     $this->Cell(20, 8, 'F_NACIM', 0, 1, 'C', 1);
 }
...
for ($i=0; $i < count($parameters['usuarios']) ; $i++) { 
    ...
    $pdf->Cell(30, 8, $parameters['usuarios'][$i]->nombreusuario, 0, 0, 'C', 0);
    $pdf->Cell(30, 8, $parameters['usuarios'][$i]->apellidousuario, 0, 0, 'C', 0);
     $pdf->Cell(20, 8, $parameters['usuarios'][$i]->direccionusuario, 0, 0, 'C', 0);
    $pdf->Cell(20, 8, $parameters['usuarios'][$i]->telefonousuario, 0, 0, 'C', 0);
     $pdf->Cell(20, 8, $parameters['usuarios'][$i]->duiusuario, 0, 0, 'C', 0);
      $pdf->Cell(50, 8, $parameters['usuarios'][$i]->sexousuario, 0, 0, 'C', 0);
       $pdf->Cell(20, 8, $parameters['usuarios'][$i]->fechanacimientousuario, 0, 1, 'C', 0);
