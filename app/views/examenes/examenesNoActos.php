			...
			<tr>
				<!-- colspan="Numero de columnas que tendra la tabla" -->
      			<th colspan="11">
                    <div class="title">
                        <p>
                            Examenes no aptos, se <?php echo $var = ($parameters['respuesta']['cuantos'] > 1)?'encontraron ':' encontro '?>
                        ...
                        <p>
                            <?php if ($parameters['busqueda'] != null):?>
                                <a href="<?php echo ROUTE_URL?>/examenes/examenesNoActos" class="btn-editar"><i
                                    class="fas fa-redo"></i>Recargar</a>
                            <?php endif?>
                            <a href="<?php echo ROUTE_URL?>/examenes/index" class="btn-editar"><i 
                                    class="fas fa-file-medical"></i> Aptos</a>
                        </p>
                    </div> 
                </th>
   	 		</tr>
        ...
        <tbody>
            ...
            <?php else:?>
			    ...
			    <tr>
                    ...
                    <a href="<?php echo ROUTE_URL?>/examenes/actualizarExamen<?php echo $var=(isset($parameters['examenes']))? '/'.$parameters['examenes'][$i]->id_exam.'/'.$parameters['respuesta']['pagina_actual']:''?><?php echo $var = ($parameters['busqueda'] != null)?'/'.str_replace(' ', '_',$parameters['busqueda']): ''?>"
	...
	<section class="paginacion">        
		<ul>
            ...
            <?php elseif ($parameters['respuesta']['pagina_actual'] >  1 || $parameters['respuesta']['error'] == null):?>
                <a class="inicio" href="<?php echo ROUTE_URL.'/examenes/examenesNoActos'?>/<?php echo $parameters['respuesta']['pagina_anterior']?><?php echo $var = ($parameters['busqueda'] != null)?'/'.str_replace(' ', '_',$parameters['busqueda']): ''?>">&laquo;</a>
            <?php endif;?>
            <?php for ($i = 1; $i <= $parameters['respuesta']['totalPaginas']; $i++):?>
                <?php if ($parameters['respuesta']['pagina_actual'] == $i):?>
			        <li class="Active">
                        <a href="<?php echo ROUTE_URL.'/examenes/examenesNoActos'?>/<?php echo $i?><?php echo $var = ($parameters['busqueda'] != null)?'/'.str_replace(' ', '_',$parameters['busqueda']): ''?>"><?php echo $i?></a>
                    </li>
                <?php else:?> 
                    <li>
                        <a href="<?php echo ROUTE_URL.'/examenes/examenesNoActos'?>/<?php echo $i?><?php echo $var = ($parameters['busqueda'] != null)?'/'.str_replace(' ', '_',$parameters['busqueda']): ''?>"><?php echo $i?></a>
            ...
            <?php elseif ($parameters['respuesta']['pagina_actual'] <  $parameters['respuesta']['totalPaginas'] || $parameters['respuesta']['error'] == null):?>
                <a class="fin" href="<?php echo ROUTE_URL.'/examenes/examenesNoActos'?>/<?php echo $parameters['respuesta']['pagina_siguiente']?><?php echo $var = ($parameters['busqueda'] != null)?'/'.str_replace(' ', '_',$parameters['busqueda']): ''?>">&raquo;</a>
            <?php endif;?> 
		</ul>
	</section>    
