        ...
        <tbody>
            ...
            <?php else:?>
			    ...
			    <tr>
                    ...
                    <a href="<?php echo ROUTE_URL?>/examenes/actualizarExamen<?php echo $var=(isset($parameters['examenes']))? '/'.$parameters['examenes'][$i]->id_exam.'/'.$parameters['respuesta']['pagina_actual'] . '/' . $parameters['busqueda']:''?>"
