<?php require_once('../app/views/inc/header.php'); ?>
      <!--  <a href="<?php echo ROUTE_URL?>/inspecciones"><i class="fas fa-arrow-circle-left" style=" color: #1236da;"></i> Regresar</a>-->
            <table>
	            <thead>
			        <tr>
                ...
                <?php if ($parameters['busqueda'] != null):?>
                    <a href="<?php echo ROUTE_URL?>/establecimientos" class="btn-editar"><i
                        class="fas fa-redo"></i>Recargar</a>
                    <?php endif?>

                    <a href="<?php echo ROUTE_URL?>/establecimientos/nuevoEstablecimiento" class="btn-ver"><i
                    ...
                    <td data-label="Opciones">
                        ...
                        <a href="<?php echo ROUTE_URL?>/establecimientos/verEstablecimiento<?php echo $var=(isset($parameters['establecimientos']))? '/'.$parameters['establecimientos'][$i]->id_estab.'/'/*.$parameters['respuesta']['pagina_actual'] . '/'*/ .'Activo/'.$parameters['busqueda']:''?>"
                            ...
                            <a href="<?php echo ROUTE_URL?>/establecimientos/actualizarEstablecimiento<?php echo $var=(isset($parameters['establecimientos']))? '/'.$parameters['establecimientos'][$i]->id_estab.'/'.$parameters['respuesta']['pagina_actual'] . '/' . $parameters['busqueda']:''?>"
                                ...
                                <a href="<?php echo ROUTE_URL.'/establecimientos/index'?>/<?php echo $parameters['respuesta']['pagina_actual']?><?php echo $var=(isset($parameters['establecimientos']))? '/'.$parameters['establecimientos'][$i]->id_estab:''?>/<?php echo 0?><?php echo $var = ($parameters['busqueda'] != null)?'/'.str_replace(' ', '_',$parameters['busqueda']): ''?>"
            ...
            <section class="paginacion">
		        <ul>
                    ...
                    <a class="inicio"
                    href="<?php echo ROUTE_URL.'/establecimientos'?>/<?php echo $parameters['respuesta']['pagina_anterior']?>/<?php echo 0?>/<?php echo 0?><?php echo $var = ($parameters['busqueda'] != null)?'/'.$parameters['busqueda']: ''?>">&laquo;</a>
                    <?php endif;?> 
                    ...
                    <li class="Active">
                    <a href="<?php echo ROUTE_URL.'/establecimientos'?>/<?php echo $i?>/<?php echo 0?>/<?php echo 0?><?php echo $var = ($parameters['busqueda'] != null)?'/'.str_replace(' ', '_',$parameters['busqueda']): ''?>"><?php echo $i?></a>
                    <!-- controlador, metodo, parametros  -->
                    </li>
                    <?php else:?>

                    <li>
                        <a href="<?php echo ROUTE_URL.'/establecimientos'?>/<?php echo $i?>/0/0<?php echo $var = ($parameters['busqueda'] != null)?'/'.str_replace(' ', '_',$parameters['busqueda']): ''?>"><?php echo $i?></a>
                    </li>
                    ...
                    <a class="fin"
                        href="<?php echo ROUTE_URL.'/establecimientos'?>/<?php echo $parameters['respuesta']['pagina_siguiente']?>/<?php echo 0?>/<?php echo 0?><?php echo $var = ($parameters['busqueda'] != null)?'/'.$parameters['busqueda']: ''?>">&raquo;</a>
                    <?php endif;?>  
		        </ul> 
	        </section>
...
<div class="box" id="eliminar-establecimiento">
    ...
    <div class="pie">
        ...
        <div class="aceptar">
            ...
            <a href="<?php echo ROUTE_URL.'/establecimientos/index'?>/<?php echo $parameters['respuesta']['pagina_actual']?>/<?php echo $var=(isset($parameters['establecimiento']))? $parameters['establecimiento']->id_estab:''?>/<?php echo 1?><?php echo $var = ($parameters['busqueda'] != null)?'/'.str_replace(' ', '_',$parameters['busqueda']): ''?>"
