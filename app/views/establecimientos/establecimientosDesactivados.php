...
<table>
   <thead>
     <tr>
        ...
        <th colspan="9">
            <div class="title">
                <p>Lista de establecimientos Inactivos, se <?php echo $var = ($parameters['respuesta']['cuantos'] > 1)?'encontraron ':' encontro '?>
                ...
                <?php if ($parameters['busqueda'] != null):?>
                    ...
                    <?php endif?>
                        <!-- <a href="<?php echo ROUTE_URL?>/usuarios/nuevoUsuario" class="btn-ver"><i
                            ...
                            Nuevo
                        usuario</a> -->
                        <a href="<?php echo ROUTE_URL?>/establecimientos/index" class="btn-editar"><i class="fas fa-user-check"></i>Activos</a>
