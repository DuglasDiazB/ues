    ...
    <div class="container" id="blur">
        <div class="contenedor active" id="contenedor">
            ...
            <nav class="menu-lateral">
                ...
                <a href="<?php echo ROUTE_URL?>/manipuladores" class="<?php echo $var=($parameters['menu'] == 'manipuladores')? 'active': ''?>" ><i class="fas fa-hand-paper"></i>Manipúladores</a>
                ...
                <a href="<?php echo ROUTE_URL?>/credenciales" class="<?php echo $var=($parameters['menu'] == 'credenciales')? 'active': ''?>" ><i class="fas fa-address-card"></i>Credenciales</a>
                
                <a href="<?php echo ROUTE_URL?>/inspecciones" class="<?php echo $var=($parameters['menu'] == 'inspecciones')? 'active': ''?>" ><i class="fas fa-user-secret"></i>Inspecciónes</a>
                
                <a href="<?php echo ROUTE_URL?>/reports" class="<?php echo $var=($parameters['menu'] == 'reports')? 'active': ''?>"><i class="fas fa-list-alt"></i>Reportes</a>
                
                
                
                
                <a href="<?php echo ROUTE_URL?>/usuarios" class="<?php echo $var=($parameters['menu'] == 'usuarios')? 'active': ''?>"><i class="fas fa-users-cog"></i>Usuarios</a>
